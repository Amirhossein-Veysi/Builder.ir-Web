        ...
        <div class="row fixed-top">
            <div class="col-12" dir="rtl">
              <nav class="navbar navbar-expand-md na  vbar-light">
                ...
                <p class="h2 mx-auto">فروشگاه همیشه بیدار ایران</p>
              </nav>
            </div>
        </div>
      </div>
                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                          <div class="carousel-inner project-img">
                            <div class="carousel-item active">
                              <img class="d-block w-100" src="../attachs/image/Slides/8_1_eShop724.svg" alt="Second slide">
