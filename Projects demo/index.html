                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                          <div class="carousel-inner project-img">
                            <div class="carousel-item active">
                              <img class="d-block w-100" src="image/ExpertClub/1_Experts-cuate.svg" alt="Second slide">
                            ...
                            <div class="carousel-item">
                              <img class="d-block w-100" src="image/ExpertClub/2_Doctors-bro.svg" alt="Third slide">
                    ...
                    <div class="col-12 col-lg-5">
                        <form class="p-5 form" action="send_mail/" method="POST">
                            ...
                            <div class="form-group d-flex justify-content-between">
                              <div class="w-50">
                                <div class="btn btn-light border mt-2 py-2">تایید هویت</div>
                                <div class="dropdown">
